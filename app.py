...
# =============================================================================
    ...
    if st.session_state.vista_actual == "planificacion":
        ...
        with tab_faltantes:
            ...
            st.info("Elige la fecha en que realizaste el equipo y dale al Ticket ✔️. El sistema calculará la semana (WK) sola y la celda de la Matriz se pondrá Verde automáticamente.")
        ...
        with tab_calendario:
            ...
            st.info("Este calendario lee los registros reales de los reportes para pintar qué equipos se mantuvieron cada día.")
