...
def obtener_tecnicos():
    ...
    # Si está vacío, retornamos al usuario logueado o uno por defecto
    usuario = st.session_state.get('usuario_actual', 'Ignacio Morales')
